    ...
    <>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>PDF to PNG</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Upload PDF files and convert each page to PNG images with transparency support
          </CardDescription>
        </CardHeader>
      ...
      <GuidanceSection title="How to Convert PDF to PNG">
        <div className="space-y-4">
          <div>
            ...
            <ol className="list-decimal pl-5 space-y-1">
              ...
              <li>Preview the converted PNG images</li>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Each PDF page becomes a separate PNG</li>
