...
export const JPEGtoWEBP = () => {
  ...
  const downloadImage = (index: number) => {
    ...
    a.download = images[index].file.name.replace(/\.jpeg$/i, ".webp");
    a.click();
  };
    ...
    <>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>JPEG to WEBP Converter</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-md">
          <CardHeader className="bg-primary/5">
            <div className="flex items-center">
              ...
              <CardTitle>JPEG to WEBP Converter</CardTitle>
            </div>
            <CardDescription>Convert JPEG images to WEBP format</CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-6 pb-4 space-y-4">
                  ...
                  {images.map((img, index) => (
                    <div key={index} className="relative group border rounded-md overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white text-xs p-1 truncate">
                        {img.file.name.replace(/\.jpeg$/i, ".webp")}
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <p className="text-sm text-muted-foreground">
              Tip: This tool converts your JPEG images to WEBP format entirely in your browser.
            </p>
          </CardContent>
        ...
        <GuidanceSection title="How to Use the JPEG to WEBP Converter">
          <div className="space-y-4">
            <div>
              <h4 className="font-medium mb-1">Step-by-step Instructions</h4>
              <ol className="list-decimal pl-5">
                <li>Click "Select JPEG Files" or drag and drop JPEG files.</li>
                <li>The images will be automatically converted to WEBP format.</li>
                <li>Preview using the eye icon and download with the download icon.</li>
                <li>Use "Clear All" to reset the selection.</li>
              </ol>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5">
                <li>Converts .jpeg files to .webp format.</li>
                <li>No upload — fully client-side and private.</li>
