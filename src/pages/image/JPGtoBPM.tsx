...
export const JPGtoBMP = () => {
  ...
  const downloadImage = (index: number) => {
    ...
    a.download = images[index].file.name.replace(/\.(jpg|jpeg)$/i, ".bmp");
    a.click();
  };
    ...
    <>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>JPG to BMP Converter</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-md">
          <CardHeader className="bg-primary/5">
            <div className="flex items-center">
              ...
              <CardTitle>JPG to BMP Converter</CardTitle>
            </div>
            <CardDescription>Convert JPG images to BMP format</CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-6 pb-4 space-y-4">
                  ...
                  {images.map((img, index) => (
                    <div key={index} className="relative group border rounded-md overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white text-xs p-1 truncate">
                        {img.file.name.replace(/\.(jpg|jpeg)$/i, ".bmp")}
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <p className="text-sm text-muted-foreground">
              Tip: This tool converts your JPG images to BMP format securely and offline.
            </p>
          </CardContent>
        ...
        <GuidanceSection title="How to Use the JPG to BMP Converter">
          <div className="space-y-4">
            <div>
              ...
              <ol className="list-decimal pl-5">
                ...
                <li>Files will be automatically converted to BMP format in your browser.</li>
                <li>Use the eye icon to preview the converted BMP image.</li>
                <li>Click the download icon to save each BMP image to your device.</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5">
                <li>Instant conversion from JPG/JPEG to BMP in the browser.</li>
