...
export const BMPtoPNG = () => {
          ...
          canvas.toBlob(blob => {
            if (blob) {
              ...
              if (processedCount === validImages.length) {
                ...
                toast({
                  title: `${newImages.length} BMP image(s) converted`,
  ...
  const downloadImage = (index: number) => {
    ...
    a.download = images[index].file.name.replace(/\.bmp$/i, ".png");
    a.click();
  };
    ...
    <>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>BMP to PNG Converter</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-md">
          <CardHeader className="bg-primary/5">
            <div className="flex items-center">
              ...
              <CardTitle>BMP to PNG Converter</CardTitle>
            </div>
            <CardDescription>Convert BMP images to PNG format</CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-6 pb-4 space-y-4">
                  ...
                  {images.map((img, index) => (
                    <div key={index} className="relative group border rounded-md overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white text-xs p-1 truncate">
                        {img.file.name.replace(/\.bmp$/i, ".png")}
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <p className="text-sm text-muted-foreground">
              Tip: This tool converts BMP images to PNG format right in your browser — securely and privately.
            </p>
          </CardContent>
        ...
        <GuidanceSection title="How to Use the BMP to PNG Converter">
          <div className="space-y-4">
            <div>
              ...
              <ol className="list-decimal pl-5">
                ...
                <li>Use the eye icon to preview or download icon to save.</li>
                <li>Click "Clear All" to reset the interface.</li>
              </ol>
            </div>
            <div>
              <h4 className="font-medium mb-1">Features</h4>
              <ul className="list-disc pl-5">
                <li>Secure client-side conversion (no uploads)</li>
                <li>Batch processing with real-time preview</li>
