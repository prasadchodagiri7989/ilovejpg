...
export const JPGtoTIFF = () => {
          ...
          canvas.toBlob(blob => {
            if (blob) {
              ...
              if (processedCount === validImages.length) {
                ...
                toast({
                  title: `${newImages.length} JPG image(s) converted`,
  ...
  const downloadImage = (index: number) => {
    ...
    a.download = images[index].file.name.replace(/\.(jpg|jpeg)$/i, ".tiff");
    a.click();
  };
    ...
    <>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>JPG to TIFF Converter</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-md">
          <CardHeader className="bg-primary/5">
            <div className="flex items-center">
              ...
              <CardTitle>JPG to TIFF Converter</CardTitle>
            </div>
            <CardDescription>Convert JPG images to TIFF format</CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-6 pb-4 space-y-4">
                  ...
                  {images.map((img, index) => (
                    <div key={index} className="relative group border rounded-md overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white text-xs p-1 truncate">
                        {img.file.name.replace(/\.(jpg|jpeg)$/i, ".tiff")}
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <p className="text-sm text-muted-foreground">
              Tip: This tool converts your JPG images to TIFF format securely and offline.
            </p>
          </CardContent>
        ...
        <GuidanceSection title="How to Use the JPG to TIFF Converter">
          <div className="space-y-4">
            <div>
              <h4 className="font-medium mb-1">Step-by-step Instructions</h4>
              <ol className="list-decimal pl-5">
                <li>Click "Select JPG Files" or drag and drop JPG images into the area.</li>
                <li>Files will be automatically converted to TIFF format in your browser.</li>
                <li>Use the eye icon to preview the converted TIFF image.</li>
                <li>Click the download icon to save each TIFF image to your device.</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5">
                <li>Instant conversion from JPG/JPEG to TIFF in the browser.</li>
                <li>No upload — fully client-side and privacy-safe.</li>
                <li>Supports batch conversion and preview before download.</li>
                <li>Clean and responsive interface with real-time feedback.</li>
              </ul>
            </div>
          </div>
        </GuidanceSection>
