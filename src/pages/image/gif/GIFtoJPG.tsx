    ...
    decodedFrames.forEach((frame, index) => {
      ...
      canvas.toBlob(blob => {
        if (blob) {
          ...
          newFrames.push({
            blobUrl,
            name: `${gifFile.name.replace(/\.gif$/i, "")}_frame_${index + 1}.jpg`,
          });
          ...
          if (newFrames.length === decodedFrames.length) {
            ...
            toast({
              ...
              description: "Each frame is now available as a JPG",
            });
            setIsLoading(false);
          }
        }
    ...
    <>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>GIF to JPG Converter</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-md">
          <CardHeader className="bg-primary/5">
            ...
            <CardDescription>Extract frames from GIF and convert to JPG</CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-6 pb-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Tip: This tool extracts individual frames from a GIF and converts each to a JPG image.
            </p>
          </CardContent>
        ...
        <GuidanceSection title="How to Use the GIF to JPG Converter">
          <div className="space-y-4">
            <div>
              <h4 className="font-medium mb-1">Steps</h4>
              <ol className="list-decimal pl-5">
                <li>Select a GIF file to extract its frames.</li>
                <li>Each frame will be converted to a JPG image.</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5">
                ...
                <li>Convert each frame into a high-quality JPG</li>
