...
export const PNGtoTIFF = () => {
  ...
  const downloadImage = (index: number) => {
    ...
    a.download = images[index].file.name.replace(/\.png$/i, ".tiff");
    a.click();
  };
    ...
    <>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>PNG to TIFF Converter</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-md">
          <CardHeader className="bg-primary/5">
            <div className="flex items-center">
              ...
              <CardTitle>PNG to TIFF Converter</CardTitle>
            </div>
            <CardDescription>Convert PNG images to TIFF format</CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-6 pb-4 space-y-4">
                  ...
                  {images.map((img, index) => (
                    <div key={index} className="relative group border rounded-md overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white text-xs p-1 truncate">
                        {img.file.name.replace(/\.png$/i, ".tiff")}
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <p className="text-sm text-muted-foreground">
              Tip: This tool converts your PNG images to TIFF format in your browser.
            </p>
          </CardContent>
        ...
        <GuidanceSection title="How to Use the PNG to TIFF Converter">
          <div className="space-y-4">
            <div>
              ...
              <ol className="list-decimal pl-5">
                ...
                <li>Files are automatically converted to TIFF format in your browser.</li>
                <li>Use the eye icon to preview each TIFF image.</li>
                <li>Click the download icon to save the TIFF image to your device.</li>
              </ol>
            </div>
            <div>
              <h4 className="font-medium mb-1">Features</h4>
              <ul className="list-disc pl-5">
                <li>Offline PNG to TIFF conversion — secure and client-side only.</li>
                <li>Batch upload, real-time preview, individual download.</li>
                <li>Same intuitive UI/UX as your other converters.</li>
              </ul>
            </div>
          </div>
        </GuidanceSection>
