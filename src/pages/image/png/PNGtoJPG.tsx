...
export const PNGtoJPG = () => {
    ...
    validImages.forEach((file) => {
      ...
      reader.onload = () => {
        ...
        img.onload = () => {
          ...
          if (ctx) {
          ctx.fillStyle = "#ffffff"; // set background to white for JPEG
  ...
  const downloadImage = (index: number) => {
    ...
    a.download = images[index].file.name.replace(/\.png$/i, ".jpg");
    a.click();
  };
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-md">
          <CardHeader className="bg-primary/5">
            ...
            <CardDescription>Convert PNG images to JPG format</CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-6 pb-4 space-y-4">
                  ...
                  {images.map((img, index) => (
                    <div key={index} className="relative group border rounded-md overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white text-xs p-1 truncate">
                        {img.file.name.replace(/\.png$/i, ".jpg")}
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <p className="text-sm text-muted-foreground">
              Tip: This tool converts your PNG images to JPG format directly in your browser.
            </p>
          </CardContent>
          ...
          <div className="space-y-4">
            <div>
              ...
              <ol className="list-decimal pl-5">
                ...
                <li>Each PNG will be converted to JPG format in your browser.</li>
                <li>Click the eye icon to preview the JPG.</li>
                <li>Click the download icon to save the JPG file.</li>
              </ol>
            </div>
            <div>
              <h4 className="font-medium mb-1">Features</h4>
              <ul className="list-disc pl-5">
                <li>Client-side PNG to JPG conversion (offline and secure).</li>
                <li>Preserves UI and batch preview interface.</li>
