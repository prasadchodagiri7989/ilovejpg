...
export const SVGtoPNG = () => {
  ...
  const downloadImage = (index: number) => {
    ...
    a.download = images[index].file.name.replace(/\.svg$/i, ".png");
    a.click();
  };
    ...
    <>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>SVG to PNG Converter</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-md">
          <CardHeader className="bg-primary/5">
            ...
            <CardDescription>Convert SVG images to PNG format</CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-6 pb-4 space-y-4">
                  ...
                  {images.map((img, index) => (
                    <div key={index} className="relative group border rounded-md overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white text-xs p-1 truncate">
                        {img.file.name.replace(/\.svg$/i, ".png")}
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <p className="text-sm text-muted-foreground">
              Tip: This tool converts your SVG images to PNG format with transparency support and high clarity.
            </p>
          </CardContent>
        ...
        <GuidanceSection title="How to Use the SVG to PNG Converter">
          <div className="space-y-4">
            <div>
              <h4 className="font-medium mb-1">Steps</h4>
              <ol className="list-decimal pl-5">
                <li>Select one or more SVG files to convert.</li>
                <li>Each file will be rendered and exported as PNG.</li>
                <li>Use the eye icon to preview or download each image.</li>
                <li>Use “Clear All” to reset the converter.</li>
              </ol>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5">
                <li>Instant in-browser conversion</li>
                <li>Batch upload & conversion</li>
                <li>No server upload — privacy friendly</li>
              </ul>
            </div>
          </div>
        </GuidanceSection>
