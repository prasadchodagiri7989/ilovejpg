...
export const XLStoCSV = () => {
  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!ext.endsWith('.xls')) {
      toast({
        title: "Only XLS files are supported",
        description: "Please upload .xls files",
        variant: "destructive",
      });
      return;
    }
    ...
    setFileName(file.name.replace(/\.xls$/i, '.csv'));
    ...
    reader.onload = (e) => {
      try {
        ...
        toast({
          ...
          description: error.message || "Failed to read XLS file",
          variant: "destructive",
        });
        console.error(error);
      }
    ...
    <>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>XLS to CSV</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Upload legacy Excel XLS files and convert to CSV format
          </CardDescription>
        </CardHeader>
      ...
      <GuidanceSection title="How to Convert XLS to CSV">
        <div className="space-y-4">
          <div>
            <h4 className="font-medium mb-2">Steps:</h4>
            <ol className="list-decimal pl-5 space-y-1">
              <li>Click 'Select XLS File' to upload a legacy Excel XLS file</li>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>Supports legacy .xls Excel format (Excel 97-2003)</li>
