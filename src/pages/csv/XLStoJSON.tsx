...
export const XLStoJSON = () => {
  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFileName(file.name.replace(/\.xls$/i, '.json'));
    ...
    <>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>XLS to JSON</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Upload legacy Excel XLS files and convert to JSON format
          </CardDescription>
        </CardHeader>
      ...
      <GuidanceSection title="How to Convert XLS to JSON">
