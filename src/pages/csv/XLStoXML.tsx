...
export const XLStoXML = () => {
  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFileName(file.name.replace(/\.xls$/i, '.xml'));
    ...
    <>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>XLS to XML</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Upload legacy Excel XLS files and convert to XML format
          </CardDescription>
        </CardHeader>
      ...
      <GuidanceSection title="How to Convert XLS to XML">
