...
export const JSONtoPDF = () => {
  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (e) => {
      ...
      setFileName(file.name.replace(/\.json$/i, '.pdf'));
    };
  ...
  const convertToPDF = () => {
    ...
    try {
      ...
      doc.setFontSize(16);
      doc.text('JSON Data', margin, yPosition);
    ...
    <>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>JSON to PDF</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Upload JSON files or paste JSON content and convert to PDF document
          </CardDescription>
        </CardHeader>
      ...
      <GuidanceSection title="How to Convert JSON to PDF">
        <div className="space-y-4">
          <div>
            <h4 className="font-medium mb-2">Steps:</h4>
            <ol className="list-decimal pl-5 space-y-1">
              <li>Click 'Select JSON File' to upload a JSON file, or paste JSON content directly</li>
              <li>The JSON will be formatted and displayed in a readable structure</li>
              <li>Click 'Convert & Download PDF' to generate and download the PDF</li>
            </ol>
          </div>
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Automatic page breaks for long content</li>
