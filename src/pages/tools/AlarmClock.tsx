...
export const AlarmClock = () => {
  ...
  const structuredData = {
    ...
    "url": "https://ilovejpg.in/alarm-clock",
    "description": "Free online alarm clock. Set alarms with custom times, choose alarm sounds, and get notifications. No installation required.",
  ...
  return (
    <>
      <SEO 
        title="Online Alarm Clock - Free & Easy to Use"
        description="Free online alarm clock tool. Set alarms with custom times, choose your alarm sound, and get instant notifications. Works in any browser, no download required."
        keywords="online alarm clock, free alarm, web alarm, browser alarm, alarm tool, online timer, wake up alarm, alarm clock online free"
