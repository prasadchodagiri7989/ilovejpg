...
const staticRoutes: SearchResult[] = [
  ...
  { id: "json-formatter", title: "JSON Formatter", path: "/json-formatter" },
  { id: "html-formatter", title: "HTML Formatter", path: "/html-formatter" },
  { id: "css-formatter", title: "CSS Formatter", path: "/css-formatter" },
  { id: "javascript-formatter", title: "JavaScript Formatter", path: "/javascript-formatter" },
  { id: "regex-tester", title: "Regex Tester", path: "/regex-tester" },
  { id: "markdown-previewer", title: "Markdown Previewer", path: "/markdown-previewer" },
  { id: "base64-encoder", title: "Base64 Encoder", path: "/base64-encoder" },
  { id: "base64-decoder", title: "Base64 Decoder", path: "/base64-decoder" },
  { id: "url-encoder", title: "URL Encoder", path: "/url-encoder" },
  { id: "url-decoder", title: "URL Decoder", path: "/url-decoder" },
  { id: "uuid-generator", title: "UUID Generator", path: "/uuid-generator" },
  // Calculator Tools
  { id: "percentage-calculator", title: "Percentage Calculator", path: "/percentage-calculator" },
  { id: "discount-calculator", title: "Discount Calculator", path: "/discount-calculator" },
  { id: "emi-calculator", title: "EMI Calculator", path: "/emi-calculator" },
  { id: "gst-calculator", title: "GST Calculator", path: "/gst-calculator" },
  { id: "age-calculator", title: "Age Calculator", path: "/age-calculator" },
  { id: "bmi-calculator", title: "BMI Calculator", path: "/bmi-calculator" },
  { id: "loan-calculator", title: "Loan Calculator", path: "/loan-calculator" },
  { id: "scientific-calculator", title: "Scientific Calculator", path: "/scientific-calculator" },
  // Data Converter Tools
  { id: "csv-to-json-converter", title: "CSV to JSON Converter", path: "/csv-to-json-converter" },
  { id: "json-to-csv-converter", title: "JSON to CSV Converter", path: "/json-to-csv-converter" },
  { id: "json-to-xml-converter", title: "JSON to XML Converter", path: "/json-to-xml-converter" },
  { id: "xml-to-json-converter", title: "XML to JSON Converter", path: "/xml-to-json-converter" },
  { id: "text-to-binary", title: "Text to Binary", path: "/text-to-binary" },
  { id: "binary-to-text", title: "Binary to Text", path: "/binary-to-text" },
  { id: "text-to-hex", title: "Text to Hex", path: "/text-to-hex" },
  { id: "hex-to-text", title: "Hex to Text", path: "/hex-to-text" },
  // Time & Date Tools
  { id: "timestamp-converter", title: "Timestamp Converter", path: "/timestamp-converter" },
  { id: "timezone-converter", title: "Timezone Converter", path: "/timezone-converter" },
  { id: "date-difference-calculator", title: "Date Difference Calculator", path: "/date-difference-calculator" },
  { id: "countdown-timer-tool", title: "Countdown Timer", path: "/countdown-timer-tool" },
  { id: "time-calculator", title: "Time Calculator", path: "/time-calculator" },
  { id: "world-clock", title: "World Clock", path: "/world-clock" },
  // Security Tools
  { id: "password-generator-tool", title: "Password Generator", path: "/password-generator-tool" },
  { id: "password-strength-checker", title: "Password Strength Checker", path: "/password-strength-checker" },
  { id: "hash-generator", title: "Hash Generator", path: "/hash-generator" },
  { id: "md5-generator", title: "MD5 Generator", path: "/md5-generator" },
  { id: "sha256-generator", title: "SHA256 Generator", path: "/sha256-generator" },
  { id: "jwt-decoder", title: "JWT Decoder", path: "/jwt-decoder" },
  // Web Utilities
  { id: "user-agent-parser", title: "User Agent Parser", path: "/user-agent-parser" },
  { id: "meta-tag-generator", title: "Meta Tag Generator", path: "/meta-tag-generator" },
  { id: "og-preview", title: "Open Graph Preview", path: "/og-preview" },
  { id: "html-preview", title: "HTML Preview", path: "/html-preview" },
  { id: "ip-lookup", title: "IP Address Lookup", path: "/ip-lookup" },
  { id: "dns-lookup", title: "DNS Lookup", path: "/dns-lookup" },
  // Social Media Tools
  { id: "hashtag-generator", title: "Hashtag Generator", path: "/hashtag-generator" },
  { id: "caption-generator", title: "Caption Generator", path: "/caption-generator" },
  { id: "youtube-thumbnail-preview", title: "YouTube Thumbnail Preview", path: "/youtube-thumbnail-preview" },
  { id: "social-post-formatter", title: "Social Post Formatter", path: "/social-post-formatter" },
  { id: "bio-generator", title: "Bio Generator", path: "/bio-generator" },
  // File Tools
  { id: "file-size-converter", title: "File Size Converter", path: "/file-size-converter" },
  { id: "file-renamer", title: "File Renamer", path: "/file-renamer" },
  { id: "file-metadata-viewer", title: "File Metadata Viewer", path: "/file-metadata-viewer" },
  { id: "file-analyzer", title: "File Analyzer", path: "/file-analyzer" },
  // Fun Tools
  { id: "typing-speed-test", title: "Typing Speed Test", path: "/typing-speed-test" },
  { id: "random-name-picker", title: "Random Name Picker", path: "/random-name-picker" },
  { id: "dice-roller", title: "Dice Roller", path: "/dice-roller" },
  { id: "yes-no-generator", title: "Yes/No Generator", path: "/yes-no-generator" },
  { id: "spin-wheel", title: "Spin Wheel", path: "/spin-wheel" },
  { id: "random-color-generator", title: "Random Color Generator", path: "/random-color-generator" },
  // Fun Games
  { id: "tic-tac-toe", title: "Tic Tac Toe", path: "/tic-tac-toe" },
  { id: "memory-game", title: "Memory Game", path: "/memory-game" },
  { id: "2048-game", title: "2048 Game", path: "/2048-game" },
  { id: "snake-game", title: "Snake Game", path: "/snake-game" },
  { id: "simon-says", title: "Simon Says", path: "/simon-says" },
  // Interactive Party Games
  { id: "truth-or-dare", title: "Truth or Dare", path: "/truth-or-dare" },
  { id: "would-you-rather", title: "Would You Rather", path: "/would-you-rather" },
  { id: "never-have-i-ever", title: "Never Have I Ever", path: "/never-have-i-ever" },
  { id: "reaction-time-test", title: "Reaction Time Test", path: "/reaction-time-test" },
  { id: "emoji-guess-game", title: "Emoji Guess Game", path: "/emoji-guess-game" },
  { id: "number-memory-challenge", title: "Number Memory Challenge", path: "/number-memory-challenge" },
  { id: "lie-detector-simulator", title: "Lie Detector Test", path: "/lie-detector-simulator" },
  { id: "personality-quiz", title: "Personality Quiz", path: "/personality-quiz" },
  { id: "decision-wheel", title: "Decision Wheel", path: "/decision-wheel" },
  // Fun Generators
  { id: "fake-chat-generator", title: "Fake Chat Generator", path: "/fake-chat-generator" },
  { id: "love-calculator", title: "Love Calculator", path: "/love-calculator" },
  { id: "excuse-generator", title: "Excuse Generator", path: "/excuse-generator" },
  { id: "pickup-line-generator", title: "Pickup Line Generator", path: "/pickup-line-generator" },
  { id: "daily-luck-meter", title: "Daily Luck Meter", path: "/daily-luck-meter" },
  { id: "random-challenge-generator", title: "Random Challenge Generator", path: "/random-challenge-generator" },
  { id: "random-story-generator", title: "Random Story Generator", path: "/random-story-generator" },
  { id: "fake-notification-generator", title: "Fake Notification Generator", path: "/fake-notification-generator" },
  { id: "mood-suggestion", title: "Mood Suggestion", path: "/mood-suggestion" },
  { id: "future-prediction", title: "Future Prediction", path: "/future-prediction" }
];
